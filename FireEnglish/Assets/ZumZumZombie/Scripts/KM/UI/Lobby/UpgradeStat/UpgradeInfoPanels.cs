...
public class UpgradeInfoPanels : MonoBehaviour
{
    ...
    private void Upgrade00()
    {
        ...
        if (!firstInit)
        {
            statIndexTxt.text = string.Format("MAX HP LV : {0}", upgradeStatInfo.level);
        ...
        else
        {
            ...
            {
                statIndexTxt.text = string.Format("MAX HP LV : MAX", upgradeStatInfo.level);
                statValueTxt.text = string.Format("maxHp : {0}", upgradeStatInfo.value);
                statPriceTxt.text = string.Format("{0}", upgradeStatInfo.price);
            }
            else
    ...
    private void Upgrade01()
    {
        ...
        if (!firstInit)
        {
            statIndexTxt.text = string.Format("Recuperative LV : {0}", upgradeStatInfo.level);
            statValueTxt.text = string.Format("Recuperative + {0}%", upgradeStatInfo.value);
            statPriceTxt.text = string.Format("{0}", upgradeStatInfo.price);
        ...
        else
        {
            ...
            {
                statIndexTxt.text = string.Format("Recuperative LV : MAX", upgradeStatInfo.level);
                statValueTxt.text = string.Format("Recuperative + {0}%", upgradeStatInfo.value);
                statPriceTxt.text = string.Format("{0}", upgradeStatInfo.price);
            }
            else
    ...
    private void Upgrade02()
    {
        ...
        if (!firstInit)
        {
            statIndexTxt.text = string.Format("Max Stamina  LV : {0}", upgradeStatInfo.level);
            statValueTxt.text = string.Format("Max Stamina : {0}", upgradeStatInfo.value);
            statPriceTxt.text = string.Format("{0}", upgradeStatInfo.price);
        ...
        else
        {
            ...
            {
                statIndexTxt.text = string.Format("Max Stamina LV : MAX", upgradeStatInfo.level);
                statValueTxt.text = string.Format("Max Stamina : {0}", upgradeStatInfo.value);
                statPriceTxt.text = string.Format("{0}", upgradeStatInfo.price);
            }
            else
    ...
    private void Upgrade03()
    {
        ...
        if (!firstInit)
        {
            statIndexTxt.text = string.Format("Stamina RecoveryLV : {0}", upgradeStatInfo.level);
            statValueTxt.text = string.Format("Stamina Recovery + {0}%", upgradeStatInfo.value);
            statPriceTxt.text = string.Format("{0}", upgradeStatInfo.price);
        ...
        else
        {
            ...
            {
                statIndexTxt.text = string.Format("Stamina RecoveryLV : MAX", upgradeStatInfo.level);
                statValueTxt.text = string.Format("Stamina Recovery + {0}%", upgradeStatInfo.value);
                statPriceTxt.text = string.Format("{0}", upgradeStatInfo.price);
            }
            else
    ...
    private void Upgrade04()
    {
        ...
        if (!firstInit)
        {
            statIndexTxt.text = string.Format("Gold Find LV : {0}", upgradeStatInfo.level);
            statValueTxt.text = string.Format("Find Gold + {0}", upgradeStatInfo.value);
            statPriceTxt.text = string.Format("{0}", upgradeStatInfo.price);
        ...
        else
        {
            ...
            {
                statIndexTxt.text = string.Format("Gold Find LV : MAX", upgradeStatInfo.level);
                statValueTxt.text = string.Format("Find Gold + {0}", upgradeStatInfo.value);
                statPriceTxt.text = string.Format("{0}", upgradeStatInfo.price);
            }
            else
